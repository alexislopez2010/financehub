...
-- ════════════════════════════════════════════════════════════════════
-- TRANSFER PAIRS (migration 0008)
-- Phase 1.3 — atomic two-row transfer RPC.
-- Historical single-row transfers are NOT backfilled here; that runs
-- as part of Phase 2 startup so the legacy Vite app keeps its current
-- view of transfers (single row, transfer_pair_id = null).
-- ════════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════════
-- ACCOUNT BALANCES SNAPSHOTS (migration 0011)
-- Phase 1.6 — per-account daily balance snapshots.
